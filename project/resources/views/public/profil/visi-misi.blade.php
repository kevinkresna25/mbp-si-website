<x-public-layout>
    ...
    <section class="bg-gradient-to-br from-emerald-700 to-emerald-900 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-3xl md:text-4xl font-bold">Visi & Misi</h1>
            <p class="text-emerald-200 mt-2">Arah dan tujuan pengelolaan Masjid Bukit Palma</p>
        </div>
    </section>
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p class="text-gray-500">Konten visi & misi belum tersedia. Silakan hubungi administrator.</p>
        </div>
        @endif
    </section>
</x-public-layout>

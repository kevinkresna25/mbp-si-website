<x-public-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <nav class="flex mb-8 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span class="mx-2">/</span>
            <span class="font-semibold text-emerald-600 dark:text-emerald-400">Visi & Misi</span>
        </nav>
        ...
        <x-bento.grid>
            ...
            <x-bento.item span="3" class="bg-gradient-to-br from-emerald-800 to-emerald-950 text-white !border-0 min-h-[240px] flex flex-col justify-center relative overflow-hidden">
                ...
                <div class="relative z-10 max-w-3xl">
                    ...
                    <h1 class="text-3xl md:text-5xl font-bold tracking-tight mb-4">Visi & Misi</h1>
                    <p class="text-emerald-200 text-lg max-w-2xl">Menjadikan Masjid Bukit Palma sebagai pusat peradaban yang mencerahkan dan memberdayakan umat.</p>
                </div>
            </x-bento.item>

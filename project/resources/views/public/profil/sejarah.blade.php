<x-public-layout>
    ...
    <x-page-header :title="$page->title ?? 'Sejarah Masjid'" subtitle="Mengenal lebih dekat bagaimana Masjid Bukit Palma berdiri dan berkembang." breadcrumb="Profil / Sejarah" />
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                {{-- Quote / Hadith --}}
                <div class="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 border border-amber-100 dark:border-amber-500/20 rounded-3xl relative overflow-hidden group hover:scale-[1.02] transition duration-500 p-8">
                     ...
                     <p class="font-medium text-lg leading-relaxed italic mb-4 text-amber-900 dark:text-amber-100 relative z-10">"Siapa yang membangun masjid karena Allah, maka Allah akan membangunkan baginya semisal di surga."</p>
                     <p class="text-xs font-bold uppercase tracking-widest text-amber-600 dark:text-amber-400 relative z-10">(HR. Bukhari & Muslim)</p>
                </div>
            </div>

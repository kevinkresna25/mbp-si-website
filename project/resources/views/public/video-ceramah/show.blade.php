<x-public-layout>
    {{-- Page Header --}}
    <x-page-header :title="$videoCeramah->judul" breadcrumb="Video / Detail">
        <div class="flex flex-wrap justify-center items-center gap-4 mt-4 animate-fade-in-up" style="animation-delay: 0.2s;">
            ...
            <div class="flex items-center gap-2 bg-emerald-100 dark:bg-emerald-900/30 px-3 py-1 rounded-full border border-emerald-200 dark:border-emerald-500/20">
                ...
                <span class="text-xs font-bold text-emerald-800 dark:text-emerald-200 uppercase tracking-wider">{{ $videoCeramah->ustadz }}</span>
            </div>
            @endif
            ...
            <div class="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 font-medium">
                <div class="flex items-center gap-1.5">
                    ...
                    {{ $videoCeramah->created_at->format('d F Y') }}
                </div>
                <div class="flex items-center gap-1.5">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="aspect-video bg-black rounded-3xl shadow-2xl overflow-hidden ring-1 ring-gray-900/5 border border-gray-100 dark:border-white/10 mb-8 animate-fade-in-up" style="animation-delay: 0.3s;">
                @if($embedUrl)

<x-public-layout>
    <x-page-header :title="$page->title" subtitle="Ajukan permohonan penggunaan fasilitas masjid untuk kegiatan Anda" breadcrumb="Layanan / Permohonan" />

    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative">
        {{-- Background Decoration --}}
        <div class="absolute top-20 left-0 w-72 h-72 bg-amber-500/10 rounded-full blur-3xl -z-10 pointer-events-none"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
             ...
             <div class="lg:col-span-2 space-y-8">
                <div class="bg-white dark:bg-slate-800 rounded-3xl border border-gray-100 dark:border-white/5 p-8 shadow-xl shadow-gray-200/50 dark:shadow-none">
                    ...
                    {{-- CTA --}}
                    <div class="mt-12 bg-gradient-to-br from-amber-50 to-white dark:from-amber-900/10 dark:to-slate-800 border border-amber-100 dark:border-amber-500/20 rounded-2xl p-8 text-center relative overflow-hidden group">
                        ...
                        <div class="absolute top-0 left-0 w-32 h-32 bg-amber-500/5 rounded-full blur-2xl -z-10"></div>

                        <div class="w-16 h-16 bg-amber-100 dark:bg-amber-900/30 rounded-2xl flex items-center justify-center mx-auto mb-6 text-amber-600 dark:text-amber-400 transform group-hover:scale-110 transition duration-300 shadow-sm">
                             <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        </div>

                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Ajukan Permohonan Sekarang</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-8 max-w-lg mx-auto leading-relaxed">
                            Butuh tempat untuk kegiatan positif? Masjid Bukit Palma memberdayakan umat dengan fasilitas terbaik.
                        </p>
                        
                        <a href="https://wa.me/{{ site_setting('social_whatsapp', '6281234567800') }}?text={{ urlencode('Assalamualaikum, saya ingin mengajukan permohonan penggunaan fasilitas ' . site_setting('site_name', 'Masjid Bukit Palma') . ' untuk kegiatan: [sebutkan kegiatan], pada tanggal: [sebutkan tanggal].') }}" target="_blank"

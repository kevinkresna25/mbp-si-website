<x-public-layout>
    ...
    <section class="py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- QRIS Section --}}
            <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-lg shadow-gray-200/50 dark:shadow-none border border-emerald-200 dark:border-emerald-500/20 p-8 mb-8 text-center relative overflow-hidden group">
                ...
                <div class="bg-gray-50 dark:bg-slate-900/50 rounded-3xl p-8 inline-block mx-auto mb-6 border border-emerald-100 dark:border-white/5 shadow-inner">
                    <div class="w-64 h-64 bg-white dark:bg-slate-700/50 rounded-2xl flex items-center justify-center mx-auto border-2 border-dashed border-gray-300 dark:border-white/10 relative group-hover:border-emerald-500/50 transition">
                ...
                <div class="flex flex-wrap justify-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">GoPay</span>
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">OVO</span>
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">DANA</span>
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">LinkAja</span>
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">ShopeePay</span>
                    <span class="px-3 py-1 bg-gray-100 dark:bg-slate-700 rounded-full border border-gray-200 dark:border-white/5">BSI Mobile</span>
                </div>
            </div>

            {{-- Category Selection --}}
            <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-lg shadow-gray-200/50 dark:shadow-none border border-emerald-200 dark:border-emerald-500/20 p-8 mb-8">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-3xl border border-emerald-100 dark:border-emerald-500/10 p-8 text-center">
                ...
                <a href="https://wa.me/6281234567890?text={{ urlencode('Assalamualaikum, saya ingin konfirmasi donasi untuk Masjid Bukit Palma.') }}"
                    target="_blank" rel="noopener"
                    class="inline-flex items-center px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl transition shadow-lg shadow-emerald-500/20 hover:scale-105 active:scale-95">
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    @foreach($donationTargets as $target)
                        <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-lg shadow-gray-200/50 dark:shadow-none border border-emerald-200 dark:border-emerald-500/20 p-6 hover:shadow-2xl hover:-translate-y-1 transition duration-300 group">

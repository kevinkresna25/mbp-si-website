            ...
            <form method="POST" action="{{ route('admin.pengumuman.store') }}">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="6" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('content') }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="expired_at" id="expired_at" value="{{ old('expired_at') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">

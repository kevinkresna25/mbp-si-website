<x-admin-layout>
    <x-slot name="header">Edit Anggota Struktur</x-slot>
            ...
            <form method="POST" action="{{ route('admin.struktur.update', $struktur) }}" enctype="multipart/form-data">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $struktur->nama) }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $struktur->jabatan) }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        @if($struktur->foto)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $struktur->foto) }}" alt="{{ $struktur->nama }}" class="w-20 h-20 rounded-lg object-cover">
                        </div>
                        @endif
                    ...
                    <div>
                        ...
                        <input type="text" name="kontak" id="kontak" value="{{ old('kontak', $struktur->kontak) }}" placeholder="No. HP / Email" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="order_column" id="order_column" value="{{ old('order_column', $struktur->order_column) }}" min="0" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">

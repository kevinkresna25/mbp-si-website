                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select name="jenis" id="jenis" required
                                ...
                                <option value="kajian" {{ old('jenis') === 'kajian' ? 'selected' : '' }}>Kajian Rutin</option>
                                <option value="maulid" {{ old('jenis') === 'maulid' ? 'selected' : '' }}>Hari Besar Islam</option>
                                <option value="sosial" {{ old('jenis') === 'sosial' ? 'selected' : '' }}>Program Sosial</option>
                                <option value="remaja" {{ old('jenis') === 'remaja' ? 'selected' : '' }}>Kegiatan Remaja</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi') }}" placeholder="Masjid Bukit Palma"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Deskripsi kegiatan..."
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                </div>

                <div class="mt-6 flex items-center space-x-3">
                    <button type="submit" class="px-5 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700 transition">Simpan Kegiatan</button>

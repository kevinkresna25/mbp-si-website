<x-admin-layout>
    <x-slot name="header">Tambah Kategori Artikel</x-slot>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('admin.article-categories.store') }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="slug" class="block text-sm font-medium text-gray-700 mb-1">Slug <span class="text-gray-400">(opsional, otomatis dari nama)</span></label>
